...
class DisplayRecording(tk.Frame):
    ...
    def __init__(self, parent_, controller_):
        ...
        self.MLplot.title.set_text('(1) Masonic Lodge')
        ...
        self.NDRplot.title.set_text('(2) Nice Drum Room')
        ...
        self.PGplot.title.set_text('(3) Parking Garage')
        ...
        self.RGTplot.title.set_text('(4) Right Glass Triangle')
        ...
        self.SCONVplot.title.set_text('(5) Record Your Own!')
        ...
        homeret.grid(row=2,column=7)

        playrec = tk.Button(self, text="Play Recording", height=10, command=lambda: self.play_recording())
        playrec.grid(row=1,column=7)
    ...
    def set_cursignal(self):
        ...
        if(inpt.isdigit() and int(inpt)>=0 and int(inpt)<=5):
